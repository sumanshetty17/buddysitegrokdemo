...
- **4 plans** (per the Final Pricing & Transaction Commission Specification, v2.0):
  - **Free ₹0/mo** — 1 store, up to 20 products, 2% BuddySite commission
  - **Starter ₹99/mo** — 1 store, up to 100 products, 2% BuddySite commission
  - **Grow ₹299/mo** — 1 store, up to 1000 products, 3.5% BuddySite commission, homepage slider / category sections / sliding products
  - **Pro ₹599/mo** — up to 3 stores, unlimited products, 5% BuddySite commission
- **Watermark** on every plan. Paid removal: ₹299 first 6 months (50% off), then ₹599 every 6 months.
